...
public class Tiling : MonoBehaviour {
	...
	// these are used for chcking if we need to instantiate stuff
	...
	private float spriteWidth = 0f;		// the with of our element
	private Camera cam;
	...
	void Update () {
		...
		if (hasALeftBuddy == false || hasARightBuddy == false) {
			...
			// calculate the x position where the camera can see the edge of the prite (element)
	...
	void MakeNewBuddy (int rightOrLeft) {
		// calculatic the new position for our new buddy
